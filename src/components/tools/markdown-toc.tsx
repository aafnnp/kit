...
class MarkdownTOCErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Markdown TOC error:', error, errorInfo)
    toast.error('An unexpected error occurred during TOC generation')
  }
