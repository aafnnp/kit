              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Select
                      value={equationType}
                      onValueChange={(value) => setEquationType(value as EquationType)}
                    >
                  ...
                  {currentSolution ? (
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-2 pt-4 border-t">
                        <Button
                          onClick={() => exportSolution(currentSolution, "json")}
                          variant="outline"
                          size="sm"
                        >
                        ...
                        <Button
                          onClick={() => exportSolution(currentSolution, "latex")}
                          variant="outline"
                          size="sm"
                        >
                          <Download className="mr-2 h-4 w-4" />
                      ...
                      >
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => exportSolution(solution, "json")}
                          >
