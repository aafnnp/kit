...
class LotteryPickerErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Lottery Picker error:', error, errorInfo)
    toast.error('An unexpected error occurred during lottery selection')
  }
