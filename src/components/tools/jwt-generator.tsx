...
class JWTGeneratorErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('JWT Generator error:', error, errorInfo)
    toast.error('An unexpected error occurred during JWT generation')
  }
