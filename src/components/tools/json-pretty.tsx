...
// Enums
type JSONOperation = 'format' | 'minify' | 'validate' | 'analyze' | 'escape' | 'unescape'
...
class JSONPrettyErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('JSON Pretty error:', error, errorInfo)
    toast.error('An unexpected error occurred during JSON processing')
  }
