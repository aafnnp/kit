        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">
              {t('tools.code-formatter.options', 'Formatting Options')}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>{t('tools.code-formatter.tab-width', 'Tab Width')}: {state.options.tabWidth}</Label>
                <input
                  type="range"
                  min={1}
                  max={8}
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded"
                />
                <Label htmlFor="use-tabs">
                  {t('tools.code-formatter.use-tabs', 'Use Tabs')}
                </Label>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="rounded"
                    />
                    <Label htmlFor="semicolons">
                      {t('tools.code-formatter.semicolons', 'Semicolons')}
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="rounded"
                    />
                    <Label htmlFor="single-quote">
                      {t('tools.code-formatter.single-quote', 'Single Quotes')}
                    </Label>
                  </div>
                </div>
