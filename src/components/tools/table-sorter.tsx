...
class TableSorterErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Table sorter error:', error, errorInfo)
    toast.error('An unexpected error occurred during table processing')
  }
