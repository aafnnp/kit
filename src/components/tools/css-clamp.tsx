...
// Enums
type CssProperty = 'font-size' | 'width' | 'height' | 'margin' | 'padding' | 'gap' | 'border-radius' | 'line-height'
type CssUnit = 'px' | 'rem' | 'em' | 'vw' | 'vh' | 'vmin' | 'vmax' | '%' | 'ch' | 'ex'
