...
// Enums
type DateFormat = 'iso8601' | 'rfc2822' | 'unix' | 'unix-ms' | 'local' | 'custom'
type DurationFormat = 'detailed' | 'compact' | 'human' | 'iso8601'
type DurationPrecision = 'milliseconds' | 'seconds' | 'minutes' | 'hours' | 'days'
