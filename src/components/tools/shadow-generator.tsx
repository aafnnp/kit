...
class ShadowGeneratorErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Shadow Generator error:', error, errorInfo)
    toast.error('An unexpected error occurred during shadow generation')
  }
