...
class FileHashErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('File Hash error:', error, errorInfo)
    toast.error('An unexpected error occurred during file hash processing')
  }
