      ...
      <div className="space-y-6">
        <Tabs defaultValue="analyze" className="w-full">
          ...
          <TabsContent value="analyze" className="space-y-4">
            ...
            {/* 反馈信息 */}
            {state.password && (passwordResult.feedback.warning || passwordResult.feedback.suggestions.length > 0 || passwordResult.feedback.positives.length > 0) && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                ...
                <CardContent className="space-y-3">
                  ...
                  {passwordResult.feedback.positives.length > 0 && (
                    <div className="space-y-2">
                      <h5 className="font-medium text-green-700">{t('tools.password-strength.strengths', 'Strengths')}</h5>
                  ...
                  {passwordResult.feedback.suggestions.length > 0 && (
                    <div className="space-y-2">
                      <h5 className="font-medium text-orange-700">{t('tools.password-strength.suggestions', 'Suggestions')}</h5>
                      <ul className="space-y-1">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label>{t('tools.password-strength.length', 'Length')}: {generationOptions.length}</Label>
                    <input
                      type="range"
                      min={4}
                      max={128}
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setGenerationOptions(prev => ({ ...prev, includeUppercase: e.target.checked }))}
                        className="w-4 h-4"
                      />
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setGenerationOptions(prev => ({ ...prev, includeLowercase: e.target.checked }))}
                        className="w-4 h-4"
                      />
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setGenerationOptions(prev => ({ ...prev, includeNumbers: e.target.checked }))}
                        className="w-4 h-4"
                      />
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setGenerationOptions(prev => ({ ...prev, includeSymbols: e.target.checked }))}
                        className="w-4 h-4"
                      />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-4 h-4"
                    />
                    <Label htmlFor="excludeSimilar">{t('tools.password-strength.exclude-similar', 'Exclude similar (il1Lo0O)')}</Label>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => setGenerationOptions(prev => ({ ...prev, excludeAmbiguous: e.target.checked }))}
                      className="w-4 h-4"
                    />
                    <Label htmlFor="excludeAmbiguous">{t('tools.password-strength.exclude-ambiguous', 'Exclude ambiguous ({}[]())')}</Label>
                  </div>
                </div>
                    ...
                    {state.generatedPasswords.map((generated) => (
                      <div key={generated.id} className="border rounded-lg p-3">
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                          <span>{t('tools.password-strength.score', 'Score')}: {generated.strength.score}/100</span>
                          <span>{t('tools.password-strength.length', 'Length')}: {generated.password.length}</span>
