...
class RegexCheatsheetErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Regex Cheatsheet error:', error, errorInfo)
    toast.error('An unexpected error occurred in the regex cheatsheet')
  }
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button onClick={() => exportPatterns(filteredPatterns, 'json')} variant="outline" size="sm">
                    <Download className="mr-2 h-4 w-4" />
                    Export JSON
                  </Button>
                  <Button onClick={() => exportPatterns(filteredPatterns, 'csv')} variant="outline" size="sm">
                    <Download className="mr-2 h-4 w-4" />
                    Export CSV
                  </Button>
                </div>
            ...
            <Card className="mt-4">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => setSelectedPattern(null)} variant="ghost" size="sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-4 border-t">
                  ...
                  <Button onClick={() => applyPatternToTester(selectedPattern)} variant="outline" size="sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="test-flags" className="text-sm font-medium">
                      Flags
                    </Label>
                    ...
                    {tests.map((test) => (
                      <div key={test.id} className="border rounded-lg p-4">
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <Button size="sm" variant="outline" onClick={() => copyToClipboard(test.pattern, 'Pattern')}>
