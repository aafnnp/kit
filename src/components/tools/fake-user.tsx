...
class FakeUserErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Fake User error:', error, errorInfo)
    toast.error('An unexpected error occurred during user generation')
  }
