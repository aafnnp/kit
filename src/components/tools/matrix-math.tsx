...
class MatrixMathErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Matrix Math error:', error, errorInfo)
    toast.error('An unexpected error occurred in the matrix calculator')
  }
