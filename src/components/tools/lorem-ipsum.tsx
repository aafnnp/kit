...
class LoremIpsumErrorBoundary extends React.Component<
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Lorem Ipsum generator error:', error, errorInfo)
    toast.error('An unexpected error occurred during text generation')
  }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="rounded border-input"
                      />
                      <Label htmlFor="useCustomWords" className="text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="absolute top-2 right-2 flex gap-2">
                  <Button size="sm" variant="outline" onClick={() => copyToClipboard(previewText.content, 'preview')}>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-wrap gap-3 justify-center">
              <Button onClick={handleGenerate} disabled={isGenerating} className="min-w-32">
                {isGenerating ? (
                  <>
              ...
              <Button onClick={handleBatchGenerate} variant="outline" disabled={isGenerating}>
              ...
              {generatedTexts.length > 0 && (
                <>
                  <Button onClick={() => exportBatch(generatedTexts)} variant="outline">
                    <Download className="mr-2 h-4 w-4" />
                    Export All
                  </Button>

                  <Button onClick={() => exportCSV(generatedTexts)} variant="outline">
                    <BarChart3 className="mr-2 h-4 w-4" />
                    Export Stats
                  </Button>

                  <Button onClick={clearAll} variant="destructive" disabled={isGenerating}>
                    Clear All
                  </Button>
                </>
              )}
                  ...
                  <div key={text.id} className="border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Button size="sm" variant="outline" onClick={() => copyToClipboard(text.content, text.id)}>
                          {copiedText === text.id ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                        </Button>

                        <Button size="sm" variant="outline" onClick={() => exportText(text)}>
                          <Download className="h-4 w-4" />
                        </Button>

                        <Button size="sm" variant="ghost" onClick={() => removeText(text.id)}>
                          ×
                        </Button>
                      </div>
                    </div>
