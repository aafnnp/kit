...
export function DependencyAnalyzer() {
  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      toast.success(t("dependencyAnalyzer.analysis-complete"))
    } catch (error) {
      toast.error(t("dependencyAnalyzer.analysis-failed"))
  ...
  const handleAuditUpload = async (file: File | null) => {
    ...
    try {
      ...
      toast.success(t("dependencyAnalyzer.audit-import-success"))
    } catch (e) {
      toast.error(t("dependencyAnalyzer.audit-parse-error"))
    }
  }
  ...
  const generateAndStoreScript = () => {
    ...
    if (plan.length === 0) {
      toast.info(t("dependencyAnalyzer.no-replacement-plan"))
      return
    }
  ...
  const exportPlanJson = () => {
    ...
    if (plan.length === 0) {
      toast.info(t("dependencyAnalyzer.no-export-plan"))
      return
    }
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button
              onClick={generateAndStoreScript}
              disabled={!analysis}
            >
              <Icon
                name="Replace"
              ...
              <Button
                ...
                onClick={() => {
                  navigator.clipboard.writeText(generatedScript).then(
                    () => toast.success(t("dependencyAnalyzer.script-copied")),
                    () => toast.error(t("dependencyAnalyzer.copy-failed"))
                  )
                }}
              >
                <Icon
            ...
            <Button
              ...
              onClick={() => {
                ...
                navigator.clipboard.writeText(cmd).then(
                  () => toast.success(t("dependencyAnalyzer.command-copied")),
                  () => toast.error(t("dependencyAnalyzer.copy-failed"))
                )
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                navigator.clipboard.writeText(cmd).then(
                  () => toast.success(t("dependencyAnalyzer.pr-command-copied")),
                  () => toast.error(t("dependencyAnalyzer.copy-failed"))
                )
              }}
            >
